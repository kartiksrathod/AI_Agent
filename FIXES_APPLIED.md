...
FRONTEND_URL=https://vulnsweeper.preview.emergentagent.com
```

### 2. `/app/.env` (Frontend)
```env
REACT_APP_BACKEND_URL=https://vulnsweeper.preview.emergentagent.com
```
...
**URL:** https://vulnsweeper.preview.emergentagent.com
