...
FRONTEND_URL=https://pipeline-repair.preview.emergentagent.com
```

### 2. `/app/.env` (Frontend)
```env
REACT_APP_BACKEND_URL=https://pipeline-repair.preview.emergentagent.com
```
...
**URL:** https://pipeline-repair.preview.emergentagent.com
