...
const ProtectedRoute = ({ children, requiredRole = null }) => {
  ...
  // If a requiredRole is provided, check it
  if (requiredRole && currentUser.role !== requiredRole && !currentUser.is_admin) {
    // Not authorized
    return <Navigate to="/" />;
  }
...
const AppContent = () => {
  ...
  const { trackActivity } = useUserState();
          ...
          <div className="min-h-screen relative">
            ...
            <div className="fixed inset-0 z-0">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "url(https://images.unsplash.com/photo-1579548122080-c35fd6820ecb?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NTY2NzR8MHwxfHNlYXJjaHw0fHxhYnN0cmFjdCUyMHRlY2hub2xvZ3l8ZW58MHx8fHwxNzU5ODU5MDgwfDA&ixlib=rb-4.1.0&q=85)",
                  backgroundSize: "cover",
                  backgroundPosition: "center",
                  backgroundRepeat: "no-repeat",
                }}
            ...
            <div className="relative z-10 flex flex-col min-h-screen text-foreground transition-colors duration-300">
              ...
              {/* AI chat assistant and other global components */}
              <AIAssistant />
              <Toaster />
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  <div className="flex flex-col items-center text-center space-y-6">
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-sm text-gray-400 mt-1">Full Stack Developer & Engineering Student</p>
                    </div>

                    {/* Social links */}
                    <div className="flex items-center justify-center space-x-8">
                      {/* GitHub */}
                      <a href="https://github.com/kartiksrathod" target="_blank" rel="noopener noreferrer" className="group flex items-center space-x-2 text-gray-300 hover:text-blue-400 transition-colors duration-300">
                      ...
                      {/* LinkedIn */}
                      <a href="https://www.linkedin.com/in/kartik-s-rathod-a98364389" target="_blank" rel="noopener noreferrer" className="group flex items-center space-x-2 text-gray-300 hover:text-blue-400 transition-colors duration-300">
                        <svg className="w-5 h-5 group-hover:scale-110 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      {/* Email */}
                      <a href="mailto:kartiksrathod07@gmail.com" className="group flex items-center space-x-2 text-gray-300 hover:text-blue-400 transition-colors duration-300">
                  ...
                  <div className="border-t border-gray-700 mt-6 pt-6 text-center">
                    <p className="text-sm text-gray-400">© 2025 EduResources - Academic Resources Platform. Built with React, FastAPI & MongoDB.</p>
                    <p className="text-xs text-gray-500 mt-1">Helping engineering students excel in their academic journey.</p>
                  </div>
                </div>
              </footer>
            </div>
